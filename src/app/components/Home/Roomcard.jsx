    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-3 flex items-center gap-3 font-sans text-xs text-stone">
                    <span>{room.size}</span>
                    <span>&middot;</span>
                ...
                <div className="mt-4 border-t border-ink/10 pt-4">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                        ...
                        href={detailsHref}
                        onClick={(e) => e.stopPropagation()}
                        className="flex-1 rounded-sm border border-ink/15 px-3 py-2 text-center font-sans text-xs uppercase tracking-wide text-ink transition hover:border-brass hover:text-brass"
                        >
                        Details
                        </Link>
                    </div>
