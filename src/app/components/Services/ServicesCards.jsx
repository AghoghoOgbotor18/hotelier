        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
                ...
                >
                    ...
                    <div className="absolute left-6 top-6 flex h-12 w-12 items-center justify-center rounded-full border border-brass bg-ink/70 text-lg text-brass backdrop-blur-sm transition-colors duration-300 group-hover:bg-brass group-hover:text-ink">
                        {service.icon}
                    </div>
