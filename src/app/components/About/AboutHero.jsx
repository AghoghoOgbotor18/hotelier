...
export default function PageBanner() {
  return (
    <header className="relative flex h-[42vh] min-h-[280px] items-end overflow-hidden">
        <img src="/images/hero1.webp" alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover object-top" />
        ...
        <div className="relative z-10 w-full px-8 pb-10 md:px-16">
            <nav className="mb-3 flex items-center gap-2 font-mono text-xs tracking-wide text-ivory/60">
                ...
                <span className="text-brass">About</span>
            </nav>
            <h1 className="font-display text-4xl font-medium text-ivory md:text-5xl pt-4">About Us</h1>
        </div>
    </header>
  );
}